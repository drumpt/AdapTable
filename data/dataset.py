...
class OpenMLRegressionDataset():
    def __init__(self, args):
        ...
        elif dataset_specification in ["abalone", "seattlecrime6", "diamonds", "Brazilian_houses", "topo_2_1", "house_sales", "particulate-matter-ukair-2017", "analcatdata_supreme", "delays_zurich_transport", "Bike_Sharing_Demand", "nyc-taxi-green-dec-2016"]:
